#ifndef NAV_FILTER_ATT04
#define NAV_FILTER_ATT04
...
/*
 * Neglects airspeed, turbulence, and wind differentials in NED.
...
class NAV_API filter_att_state04 : public nav::ekf_state_<16> {
private:
...
public:
    ...
    explicit filter_att_state04(const sens::suite& Osuite);
    /**< default constructor */
    filter_att_state04() = delete;
    /**< copy constructor */
    filter_att_state04(const filter_att_state04&) = delete;
    /**< move constructor */
    filter_att_state04(filter_att_state04&&) = delete;
    /**< destructor */
    ~filter_att_state04() = default;
    /**< copy assignment */
    filter_att_state04& operator=(const filter_att_state04&) = delete;
    /**< move assignment */
    filter_att_state04& operator=(filter_att_state04&&) = delete;
...
}; // closes class filter_att_state04
...
class NAV_API filter_att_obser04 : public nav::ekf_obser_<16,9,9> {
private:
...
public:
    ...
    filter_att_obser04(const sens::suite& Osuite, const env::geo& Ogeo);
    /**< default constructor */
    filter_att_obser04() = delete;
    /**< copy constructor */
    filter_att_obser04(const filter_att_obser04&) = delete;
    /**< move constructor */
    filter_att_obser04(filter_att_obser04&&) = delete;
    /**< destructor */
    ~filter_att_obser04();
    /**< copy assignment */
    filter_att_obser04& operator=(const filter_att_obser04&) = delete;
    /**< move assignment */
    filter_att_obser04& operator=(filter_att_obser04&&) = delete;
...
}; // closes class filter_att_obser04
...
public:
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    /**< constructor based on suite of sensors and Earth model */
    filter_att04(const sens::suite& Osuite, const env::geo& Ogeo);
    /**< default constructor */
    filter_att04() = delete;
    /**< copy constructor */
    filter_att04(const filter_att04&) = delete;
    /**< move constructor */
    filter_att04(filter_att04&&) = delete;
    /**< destructor */
    ~filter_att04();
    /**< copy assignment */
    filter_att04& operator=(const filter_att04&) = delete;
    /**< move assignment */
    filter_att04& operator=(filter_att04&&) = delete;
