...
// CLASS FILTER ATTITUDE04
// =======================
// =======================

using namespace std;

void nav::filter_att04::textplot(const boost::filesystem::path& path_folder, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
...
void nav::filter_att04::textplot_qnb(const std::string& txt_file_qnb, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
...
void nav::filter_att04::textplot_euler(const std::string& txt_file_euler, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
    double r2d = math::constant::R2D();
...
void nav::filter_att04::textplot_wnbb(const std::string& txt_file_wnbb, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
    double r2d = math::constant::R2D();
...
void nav::filter_att04::textplot_E_gyr(const std::string& txt_file_E_gyr, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
    double r2d = math::constant::R2D();
...
void nav::filter_att04::textplot_E_mag(const std::string& txt_file_E_mag, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
    ofstream Oout_E_mag;
    ...
    Oout_E_mag << setw(10) << "t_sec"
                  ...
                  << setw(42) << "E_mag_nT error std -"
                  << setw(42) << "B_n_dev_nT +"      << setw(42) << "B_n_dev_nT -"     << setw(42) << "B_n_dev_nT T"
                  << setw(42) << "B_n_dev_nT error std +"
                  << setw(42) << "B_n_dev_nT error std -"
                  << endl;
    ...
    for (unsigned int s = 0; s != (Otrj_sens_in.get_nel()); ++s) {
        Oout_E_mag << fixed    << setw(10) << setprecision(3) << showpos << Otrj_nav_out()[s].get_t_sec()                    // t_sec
                      ...
                      << scientific << setw(14) << setprecision(5) << showpos << Otrj_nav_out()[s].get_B_n_nT_dev()[0]     // B_n0_nT_dev estimated (a posteriori)
                      << scientific << setw(14) << setprecision(5) << showpos << Otrj_nav_out()[s].get_B_n_nT_dev()[1]     // B_n1_nT_dev estimated (a posteriori)
                      << scientific << setw(14) << setprecision(5) << showpos << Otrj_nav_out()[s].get_B_n_nT_dev()[2]     // B_n2_nT_dev estimated (a posteriori)
                      << scientific << setw(14) << setprecision(5) << showpos << _Pekf_handler->get_xhat_bef()[s](13)        // B_n0_nT_dev estimated (a priori)
                      << scientific << setw(14) << setprecision(5) << showpos << _Pekf_handler->get_xhat_bef()[s](14)        // B_n1_nT_dev_nT estimated (a priori)
                      << scientific << setw(14) << setprecision(5) << showpos << _Pekf_handler->get_xhat_bef()[s](15)        // B_n2_nT_dev estimated (a priori)
                      << scientific << setw(14) << setprecision(5) << showpos << Otrj_nav_in()[s].get_B_n_nT_dev()(0)      // B_n0_nT_dev truth
                      << scientific << setw(14) << setprecision(5) << showpos << Otrj_nav_in()[s].get_B_n_nT_dev()(1)      // B_n1_nT_dev truth
                      << scientific << setw(14) << setprecision(5) << showpos << Otrj_nav_in()[s].get_B_n_nT_dev()(2)      // B_n2_nT_dev truth
                      << scientific << setw(14) << setprecision(5) << showpos << sqrt(_Pekf_handler->get_P_aft()[s](13,13))  // a posteriori B_n0_nT_dev standard deviation
                      << scientific << setw(14) << setprecision(5) << showpos << sqrt(_Pekf_handler->get_P_aft()[s](14,14))  // a posteriori B_n1_nT_dev standard deviation
                      << scientific << setw(14) << setprecision(5) << showpos << sqrt(_Pekf_handler->get_P_aft()[s](15,15))  // a posteriori B_n2_nT_dev standard deviation
                      << scientific << setw(14) << setprecision(5) << showpos << sqrt(_Pekf_handler->get_P_bef()[s](13,13))  // a priori B_n0_nT_dev standard deviation
                      << scientific << setw(14) << setprecision(5) << showpos << sqrt(_Pekf_handler->get_P_bef()[s](14,14))  // a priori B_n1_nT_dev standard deviation
                      << scientific << setw(14) << setprecision(5) << showpos << sqrt(_Pekf_handler->get_P_bef()[s](15,15))  // a priori B_n2_nT_dev standard deviation
                      << endl;
    }
    Oout_E_mag.close();
}
...
void nav::filter_att04::textplot_obs_gyr(const std::string& txt_file_obs_gyr, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
    double r2d = math::constant::R2D();
...
void nav::filter_att04::textplot_obs_acc(const std::string& txt_file_obs_acc, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
...
void nav::filter_att04::textplot_obs_mag(const std::string& txt_file_obs_mag, const st::trj_sens_in& Otrj_sens_in, const st::trj_sens_out& Otrj_sens_out, const st::trj_nav_in& Otrj_nav_in, const st::trj_nav_out& Otrj_nav_out) const {
