#ifndef NAV_FILTER_ATT01
#define NAV_FILTER_ATT01
...
/*
 * Uses external variables: initial NED gravity, initial NED magnetic field, initial q_nb.
 */

/* This filter does not work properly with a varying magnetic field. It is kept for
 * reference but has been replaced by filter_att02.
 */
...
class NAV_API filter_att_state01 : public nav::ekf_state_<13> {
private:
    /**< discrete time linear state covariance matrix */
    Eigen::Matrix<double,13,13> _Qtilde;
...
public:
    ...
    explicit filter_att_state01(const sens::suite& Osuite);
    /**< default constructor */
    filter_att_state01() = delete;
    /**< copy constructor */
    filter_att_state01(const filter_att_state01&) = delete;
    /**< move constructor */
    filter_att_state01(filter_att_state01&&) = delete;
    /**< destructor */
    ~filter_att_state01() = default;
    /**< copy assignment */
    filter_att_state01& operator=(const filter_att_state01&) = delete;
    /**< move assignment */
    filter_att_state01& operator=(filter_att_state01&&) = delete;

    /**< initialization */
    void initialize();
    /**< updates the functor based on previous EKF state estimation and previous sensors outputs */
    void update(const Eigen::Matrix<double,13,1>& xhat_aft_prev);
    /**< evaluates functor based on previous EKF state estimation, returning vector of size z. */
    Eigen::Matrix<double,13,1> eval(const Eigen::Matrix<double,13,1>& xhat_aft_prev) const override;
    /**< evaluates jacobian of functor with respect to state vector x based on state vector. */
    void jacobian_state(Eigen::Matrix<double,13,13>& A, const Eigen::Matrix<double,13,1>& xhat_aft_prev) const override;
    /**< returns covariance matrix */
    Eigen::Matrix<double,13,13> covariance_matrix() const override;
}; // closes class filter_att_state01
...
class NAV_API filter_att_obser01 : public nav::ekf_obser_<13,9,9> {
private:
...
public:
    ...
    filter_att_obser01(const sens::suite& Osuite, const env::geo& Ogeo);
    /**< default constructor */
    filter_att_obser01() = delete;
    /**< copy constructor */
    filter_att_obser01(const filter_att_obser01&) = delete;
    /**< move constructor */
    filter_att_obser01(filter_att_obser01&&) = delete;
    /**< destructor */
    ~filter_att_obser01() = default;
    /**< copy assignment */
    filter_att_obser01& operator=(const filter_att_obser01&) = delete;
    /**< move assignment */
    filter_att_obser01& operator=(filter_att_obser01&&) = delete;

    /**< updates the functor based on current EKF state estimation, current sensors outputs, and XXXXXXXXX */
    void update(const Eigen::Matrix<double,13,1>& xhat_bef, const st::st_nav_out& Ost_nav_out_prev);
    /**< evaluates functor based on current EKF state estimation, returning vector of size z. */
    Eigen::Matrix<double,9,1> eval(const Eigen::Matrix<double,13,1>& xhat_bef) const override;
    /**< evaluates jacobian of functor with respect to state vector x based on state vector. */
    void jacobian_state(Eigen::Matrix<double,9,13>& output, const Eigen::Matrix<double,13,1>& xhat) const override;
    /**< evaluates jacobian of functor with respect to noise vector (w or v) based on state vector. */
    void jacobian_noise(Eigen::Matrix<double,9,9>& output, const Eigen::Matrix<double,13,1>& xhat) const override;
    /**< returns covariance matrix */
    Eigen::Matrix<double,9,9> covariance_matrix() const override;
}; // closes class filter_att_obser01
...
class NAV_API filter_att01 : public filter_att {
private:
    /**< pointer to extended Kalman filter */
    nav::ekf_handler_<13,9,13,9>* _Pekf_handler;
    /**< pointer to state functor */
    nav::filter_att_state01* _Pstate;
    /**< pointer to observation functor */
    nav::filter_att_obser01* _Pobser;

    /**< vector of observations */
    Eigen::Matrix<double,9,1> _y;
    /**< vector of truth states for filter evaluation */
    Eigen::Matrix<double,13,1> _Vx_truth;
...
public:
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    /**< constructor based on suite of sensors and Earth model */
    filter_att01(const sens::suite& Osuite, const env::geo& Ogeo);
    /**< default constructor */
    filter_att01() = delete;
    /**< copy constructor */
    filter_att01(const filter_att01&) = delete;
    /**< move constructor */
    filter_att01(filter_att01&&) = delete;
    /**< destructor */
    ~filter_att01();
    /**< copy assignment */
    filter_att01& operator=(const filter_att01&) = delete;
    /**< move assignment */
    filter_att01& operator=(filter_att01&&) = delete;
