#ifndef NAV_FILTER_ATT02
#define NAV_FILTER_ATT02
...
/*
 * Neglects airspeed and turbulence differentials in body and wind diferential in NED.
 */
...
class NAV_API filter_att_state02 : public nav::ekf_state_<16> {
private:
...
public:
    ...
    explicit filter_att_state02(const sens::suite& Osuite);
    /**< default constructor */
    filter_att_state02() = delete;
    /**< copy constructor */
    filter_att_state02(const filter_att_state02&) = delete;
    /**< move constructor */
    filter_att_state02(filter_att_state02&&) = delete;
    /**< destructor */
    ~filter_att_state02() = default;
    /**< copy assignment */
    filter_att_state02& operator=(const filter_att_state02&) = delete;
    /**< move assignment */
    filter_att_state02& operator=(filter_att_state02&&) = delete;
...
}; // closes class filter_att_state02
...
class NAV_API filter_att_obser02 : public nav::ekf_obser_<16,9,9> {
private:
...
public:
    ...
    filter_att_obser02(const sens::suite& Osuite, const env::geo& Ogeo);
    /**< default constructor */
    filter_att_obser02() = delete;
    /**< copy constructor */
    filter_att_obser02(const filter_att_obser02&) = delete;
    /**< move constructor */
    filter_att_obser02(filter_att_obser02&&) = delete;
    /**< destructor */
    ~filter_att_obser02();
    /**< copy assignment */
    filter_att_obser02& operator=(const filter_att_obser02&) = delete;
    /**< move assignment */
    filter_att_obser02& operator=(filter_att_obser02&&) = delete;
...
}; // closes class filter_att_obser02
...
public:
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    /**< constructor based on suite of sensors and Earth model */
    filter_att02(const sens::suite& Osuite, const env::geo& Ogeo);
    /**< default constructor */
    filter_att02() = delete;
    /**< copy constructor */
    filter_att02(const filter_att02&) = delete;
    /**< move constructor */
    filter_att02(filter_att02&&) = delete;
    /**< destructor */
    ~filter_att02();
    /**< copy assignment */
    filter_att02& operator=(const filter_att02&) = delete;
    /**< move assignment */
    filter_att02& operator=(filter_att02&&) = delete;
