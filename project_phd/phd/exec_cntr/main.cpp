...
int main(int argc, char **argv) {
    unsigned short case_guid, seed_order;
    double turb_factor;
    switch (argc) {
        case 1:
            case_guid   = 58;
        ...
        case 3: {
            ...
            break; }
        default:
            throw std::runtime_error("Wrong number of input parameters. Either 0 or 3 (case_guid & seed_order & turb_factor) ");
    }

    double t_sec_init       = -50.0;
    double t_sec_end        = 250.0;
    int    t_sec_turb       = 1000;
    double t_sec_gpsloss    = 0.; //t_sec_end;

    sens::logic::SENS_COMPLETE_ID sens_complete_id = sens::logic::sens_complete_bias_scale_par;
    nav::logic::NAV_ID nav_id                      = nav::logic::nav_id020202; // id020202
