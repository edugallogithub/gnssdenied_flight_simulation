...
#ifndef MATH_INTERP_LAGRANGE_FIRST_H
#define MATH_INTERP_LAGRANGE_FIRST_H

#include "../math.h"
#include "interp.h"

/*
This file contains the interp_lagrange_first class, which implements the l
Lagrange 1st order interpolation (based on 2 inputs). This is by far the
quickest way of interpolation, but has the drawbacks of (1) reduced accuracy
and (2) non continuous first differentials at the nodes.
*/
...
class MATH_API interp_lagrange_first: public interp {
private:
...
public:
	interp_lagrange_first(){}
	/* empty constructor */
	interp_lagrange_first(const interp_lagrange_first&){}
	/**< copy constructor */
	interp_lagrange_first& operator=(const interp_lagrange_first& op2) {return *this;}
	...
	rat3 and rat4 */
}; // closes class interp_lagrange_first
