#ifndef MATH_INTERP_BIPARABOLIC_H
#define MATH_INTERP_BIPARABOLIC_H

#include "../math.h"
#include "interp.h"

/*
This file contains the interp_biparabolic class, which implements the
biparabolic interpolation (based on 4 inputs). It combines two 2nd order
lagrange interpolations (for the points 1 through 3 and 2 through 4)
plus a 1st order interpolation of the results, obtaining continuous
first differentials at the nodes.
*/
...
class MATH_API interp_biparabolic: public interp {
private:
...
public:
	interp_biparabolic(){}
	/* empty constructor */
	interp_biparabolic(const interp_biparabolic&){}
	/**< copy constructor */
	interp_biparabolic& operator=(const interp_biparabolic& op2) {return *this;}
	...
	rat3 and rat4 */
}; // closes class interp_biparabolic
