#ifndef MATH_INTERP_LAGRANGE_THIRD_H
#define MATH_INTERP_LAGRANGE_THIRD_H

#include "../math.h"
#include "interp.h"

/*
This file contains the interp_lagrange_third class, which implements the
Lagrange 3rd order interpolation (based on 4 inputs). It is slower than
2nd order interpolation (in particular when employed in multiple dimensions) 
...
class MATH_API interp_lagrange_third: public interp {
private:
...
public:
	interp_lagrange_third(){}
	/* empty constructor */
	interp_lagrange_third(const interp_lagrange_third&){}
	/**< copy constructor */
	interp_lagrange_third& operator=(const interp_lagrange_third& op2) {return *this;}
	...
	rat3 and rat4 */
}; // closes class interp_lagrange_third
