...
nav::test::Tplots_init::Tplots_init(unsigned short& seed_init, unsigned short& seed_end)
: _seed_init(seed_init), _seed_end(seed_end) {
}
/* constructor based on counter */

void nav::test::Tplots_init::run() {
    obtain_euler_init_att_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_init_att_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_init_att_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);

    obtain_euler_init_gyr_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_init_gyr_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_init_gyr_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);

    obtain_euler_init_acc_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_init_acc_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_init_acc_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);

    obtain_euler_init_mag_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_init_mag_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_init_mag_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);

    obtain_euler_init_mgn_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_init_mgn_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_init_mgn_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);
...
void nav::test::Tplots_init::obtain_euler_init_att_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_ATT_WORSE";
    std::string st_folder_one3 = "INIT_ATT_WORST";
    ...
    std::string st_extra_folder("versus_init");
    ...
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "INIT ATT worse" << setw(21) << "INIT ATT worst" << std::endl;
    std::cout << setw(10) << " "
    ...
    std::string st_file_out = "versus_init_att_euler_deg.txt";
    ...
    std::string st_file_out_tex = "versus_init_att_euler_table.tex";
    ...
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{Initial Attitude Estimation}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\| \\phiNBest - \\phiNB \\| \\ \\lrsb{deg}} & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{3}{c}{\\textbf{Worse}} & \\multicolumn{3}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
...
void nav::test::Tplots_init::obtain_vn_init_att_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_ATT_WORSE";
    std::string st_folder_one3 = "INIT_ATT_WORST";
    ...
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "INIT ATT worse" << setw(24) << "INIT ATT worst" << std::endl;
    ...
    std::string st_file_out = "versus_init_att_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_att_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{6}{c}{\\textbf{Initial Attitude Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
...
void nav::test::Tplots_init::obtain_xhor_init_att_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_ATT_WORSE";
    std::string st_folder_one3 = "INIT_ATT_WORST";
    ...
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "INIT ATT worse" << "INIT ATT worst" << std::endl;
    std::cout << setw(10) << " "
    ...
    std::string st_file_out = "versus_init_att_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_att_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{7}{c}{\\textbf{Initial Attitude Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
...
void nav::test::Tplots_init::obtain_euler_init_gyr_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_GYR_WORSE";
    std::string st_folder_one3 = "INIT_GYR_WORST";
    ...
    std::cout << std::endl;
    std::cout << "phiNB [deg] attitude estimation errors (est - truth)" << std::endl;
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "INIT GYR worse" << setw(21) << "INIT GYR worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
    ...
    std::string st_file_out = "versus_init_gyr_euler_deg.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_gyr_euler_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{Initial Gyroscope Error Estimation}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\| \\phiNBest - \\phiNB \\| \\ \\lrsb{deg}} & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{3}{c}{\\textbf{Worse}} & \\multicolumn{3}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\mumu{}, \\, \\musigma{}, \\, \\mumax{\\cdot}} "
             << " & \\textbf{"
...
void nav::test::Tplots_init::obtain_vn_init_gyr_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_GYR_WORSE";
    std::string st_folder_one3 = "INIT_GYR_WORST";
    ...
    std::cout << std::endl;
    std::cout << "Final vni and vnii [mps] estimation errors (est - truth):" << std::endl;
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "INIT GYR worse" << setw(24) << "INIT GYR worst" << std::endl;
    std::cout << setw(10) << " " << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << std::endl;
    ...
    std::string st_file_out = "versus_init_gyr_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_gyr_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{6}{c}{\\textbf{Initial Gyroscope Error Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\lrsb{m/sec}} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{}} "
...
/* reads the horizontal ground velocity estimation resultsfrom two sets of files, the baseline and one employing
     * worse gyroscope bias initialization.
...
void nav::test::Tplots_init::obtain_xhor_init_gyr_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_GYR_WORSE";
    std::string st_folder_one3 = "INIT_GYR_WORST";
    ...
    std::cout << std::endl;
    std::cout << "xhor position filter error [m,%]:" << std::endl;
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "INIT GYR worse" << "INIT GYR worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
    ...
    std::string st_file_out = "versus_init_gyr_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_gyr_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{7}{c}{\\textbf{Initial Gyroscope Error Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << " & Distance \\nm{\\lrsb{m}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{\\Deltaxhor}} "
...
/* reads the final horizontal position resultsfrom two sets of files, the baseline and one employing
     * worse gyroscope bias initialization.
 * It shows results on console and also generates the following files (for thesis, not Matlab):
...
void nav::test::Tplots_init::obtain_euler_init_acc_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_ACC_WORSE";
    std::string st_folder_one3 = "INIT_ACC_WORST";
    ...
    std::cout << std::endl;
    std::cout << "phiNB [deg] attitude estimation errors (est - truth)" << std::endl;
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "INIT ACC worse" << setw(21) << "INIT ACC worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
    ...
    std::string st_file_out = "versus_init_acc_euler_deg.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_acc_euler_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{Initial Accelerometer Error Estimation}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\| \\phiNBest - \\phiNB \\| \\ \\lrsb{deg}} & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{3}{c}{\\textbf{Worse}} & \\multicolumn{3}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\mumu{}, \\, \\musigma{}, \\, \\mumax{\\cdot}} "
             << " & \\textbf{"
...
void nav::test::Tplots_init::obtain_vn_init_acc_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_ACC_WORSE";
    std::string st_folder_one3 = "INIT_ACC_WORST";
    ...
    std::cout << std::endl;
    std::cout << "Final vni and vnii [mps] estimation errors (est - truth):" << std::endl;
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "INIT ACC worse" << setw(24) << "INIT ACC worst" << std::endl;
    std::cout << setw(10) << " " << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << std::endl;
    ...
    std::string st_file_out = "versus_init_acc_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_acc_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{6}{c}{\\textbf{Initial Accelerometer Error Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\lrsb{m/sec}} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{}} "
...
void nav::test::Tplots_init::obtain_xhor_init_acc_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_ACC_WORSE";
    std::string st_folder_one3 = "INIT_ACC_WORST";
    ...
    std::cout << std::endl;
    std::cout << "xhor position filter error [m,%]:" << std::endl;
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "INIT ACC worse" << "INIT ACC worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
    ...
    std::string st_file_out = "versus_init_acc_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_acc_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{7}{c}{\\textbf{Initial Accelerometer Error Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << " & Distance \\nm{\\lrsb{m}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{\\Deltaxhor}} "
...
void nav::test::Tplots_init::obtain_euler_init_mag_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_MAG_WORSE";
    std::string st_folder_one3 = "INIT_MAG_WORST";
    ...
    std::cout << std::endl;
    std::cout << "phiNB [deg] attitude estimation errors (est - truth)" << std::endl;
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "INIT MAG worse" << setw(21) << "INIT MAG worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
    ...
    std::string st_file_out = "versus_init_mag_euler_deg.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_mag_euler_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{Initial Magnetometer Error Estimation}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\| \\phiNBest - \\phiNB \\| \\ \\lrsb{deg}} & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{3}{c}{\\textbf{Worse}} & \\multicolumn{3}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\mumu{}, \\, \\musigma{}, \\, \\mumax{\\cdot}} "
             << " & \\textbf{"
...
void nav::test::Tplots_init::obtain_vn_init_mag_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_MAG_WORSE";
    std::string st_folder_one3 = "INIT_MAG_WORST";
    ...
    std::cout << std::endl;
    std::cout << "Final vni and vnii [mps] estimation errors (est - truth):" << std::endl;
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "INIT MAG worse" << setw(24) << "INIT MAG worst" << std::endl;
    std::cout << setw(10) << " " << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << std::endl;
    ...
    std::string st_file_out = "versus_init_mag_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_mag_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{6}{c}{\\textbf{Initial Magnetometer Error Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\lrsb{m/sec}} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{}} "
...
void nav::test::Tplots_init::obtain_xhor_init_mag_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_MAG_WORSE";
    std::string st_folder_one3 = "INIT_MAG_WORST";
    ...
    std::cout << std::endl;
    std::cout << "xhor position filter error [m,%]:" << std::endl;
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "INIT MAG worse" << "INIT MAG worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
    ...
    std::string st_file_out = "versus_init_mag_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_mag_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{7}{c}{\\textbf{Initial Magnetometer Error Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << " & Distance \\nm{\\lrsb{m}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{\\Deltaxhor}} "
...
void nav::test::Tplots_init::obtain_euler_init_mgn_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_MGN_WORSE";
    std::string st_folder_one3 = "INIT_MGN_WORST";
    ...
    std::cout << std::endl;
    std::cout << "phiNB [deg] attitude estimation errors (est - truth)" << std::endl;
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "INIT MGN worse" << setw(21) << "INIT MGN worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
              << setw(7) << "mean" << setw(7) << "std" << setw(7) << "smax"
    ...
    std::string st_file_out = "versus_init_mgn_euler_deg.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_mgn_euler_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{Initial Magnetic Field Estimation}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\| \\phiNBest - \\phiNB \\| \\ \\lrsb{deg}} & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{3}{c}{\\textbf{Worse}} & \\multicolumn{3}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\mumu{}, \\, \\musigma{}, \\, \\mumax{\\cdot}} "
             << " & \\textbf{"
...
void nav::test::Tplots_init::obtain_vn_init_mgn_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_MGN_WORSE";
    std::string st_folder_one3 = "INIT_MGN_WORST";
    ...
    std::cout << std::endl;
    std::cout << "Final vni and vnii [mps] estimation errors (est - truth):" << std::endl;
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "INIT MGN worse" << setw(24) << "INIT MGN worst" << std::endl;
    std::cout << setw(10) << " " << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << setw(12) << "vni" << setw(12) << "vnii"
              << std::endl;
    ...
    std::string st_file_out = "versus_init_mgn_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_mgn_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{6}{c}{\\textbf{Initial Magnetic Field Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\lrsb{m/sec}} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{}} "
...
void nav::test::Tplots_init::obtain_xhor_init_mgn_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "MAIN";
    std::string st_folder_one2 = "INIT_MGN_WORSE";
    std::string st_folder_one3 = "INIT_MGN_WORST";
    ...
    std::cout << std::endl;
    std::cout << "xhor position filter error [m,%]:" << std::endl;
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "INIT MGN worse" << "INIT MGN worst" << std::endl;
    std::cout << setw(10) << " "
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
    ...
    std::string st_file_out = "versus_init_mgn_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_init_mgn_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{7}{c}{\\textbf{Initial Magnetic Field Estimation}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << " & Distance \\nm{\\lrsb{m}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{\\Deltaxhor}} "
