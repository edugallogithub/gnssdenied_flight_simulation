...
nav::test::Tplots_sensors_mag::Tplots_sensors_mag(unsigned short& seed_init, unsigned short& seed_end)
: _seed_init(seed_init), _seed_end(seed_end) {
}
/* constructor based on counter */

void nav::test::Tplots_sensors_mag::run() {
    obtain_euler_mag_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_mag_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_mag_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);

    obtain_euler_mag_alter_metrics("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_vn_mag_alter_metrics   ("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_xhor_mag_alter_metrics ("03_01_05_03_04_0100", _seed_init, _seed_end);
}
...
void nav::test::Tplots_sensors_mag::obtain_euler_mag_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "MAIN";
    std::string st_folder_one_mag2 = "MAG_BETTER";
    std::string st_folder_one_mag3 = "MAG_WORSE";
    ...
    std::string st_extra_folder("versus_mag");
    std::string st_file("filter_att_euler.txt");

    std::string st_seeds, st_file_complete, st_first_line, st_file_complete_mag2, st_file_complete_mag3;
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        st_file_complete_mag2 = (path_outputs_read / st_folder_main / st_folder_one_mag2 / st_folder / st_file).string();
        st_file_complete_mag3 = (path_outputs_read / st_folder_main / st_folder_one_mag3 / st_folder / st_file).string();
        ...
        Ostream2.open(st_file_complete_mag2);
        ...
        Ostream3.open(st_file_complete_mag3);
    ...
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "MAG better" << setw(21) << "MAG worse" << std::endl;
    std::cout << setw(10) << " "
    ...
    std::string st_file_out = "versus_mag_euler_deg.txt";
    ...
    std::string st_file_out_tex = "versus_mag_euler_table.tex";
    ...
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{MAG Configuration} \\nm{\\lrsb{deg}}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_mag::obtain_vn_mag_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "MAIN";
    std::string st_folder_one_mag2 = "MAG_BETTER";
    std::string st_folder_one_mag3 = "MAG_WORSE";
    ...
    std::string st_seeds, st_file_gps_complete, st_first_line, st_line, st_file_gps_complete_mag2, st_file_gps_complete_mag3;
    std::string st_file_pos_complete, st_file_pos_complete_mag2, st_file_pos_complete_mag3;
    unsigned long nel     = (unsigned long)(seed_end) - (unsigned long)(seed_init) + 1;
    unsigned long nel_all = 380001;
    unsigned long nel_sec = 381;
    unsigned long index_all, index_sec;
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        st_file_gps_complete_mag2 = (path_outputs_read / st_folder_main / st_folder_one_mag2 / st_folder / st_file_gps).string();
        st_file_gps_complete_mag3 = (path_outputs_read / st_folder_main / st_folder_one_mag3 / st_folder / st_file_gps).string();
        st_file_pos_complete      = (path_outputs_read / st_folder_main / st_folder_one      / st_folder / st_file_pos).string();
        st_file_pos_complete_mag2 = (path_outputs_read / st_folder_main / st_folder_one_mag2 / st_folder / st_file_pos).string();
        st_file_pos_complete_mag3 = (path_outputs_read / st_folder_main / st_folder_one_mag3 / st_folder / st_file_pos).string();
        ...
        std::ifstream Ostream_gps_mag2;
        Ostream_gps_mag2.open(st_file_gps_complete_mag2);
        std::getline(Ostream_gps_mag2, st_first_line);
        ...
        while (std::getline(Ostream_gps_mag2, st_line)) {
            st_t_sec          = st_line.substr(  0, 10);
            st_vni_mps_est    = st_line.substr( 10, 14);
            st_vnii_mps_est   = st_line.substr( 24, 14);
            st_vni_mps_truth  = st_line.substr( 94, 14);
        ...
        Ostream_gps_mag2.close();

        std::ifstream Ostream_pos_mag2;
        Ostream_pos_mag2.open(st_file_pos_complete_mag2);
        std::getline(Ostream_pos_mag2, st_first_line);
        std::getline(Ostream_pos_mag2, st_line); // line repeated at 100 [sec] from previous file
        while (std::getline(Ostream_pos_mag2, st_line)) {
            st_t_sec          = st_line.substr(  0, 10);
            st_vni_mps_est    = st_line.substr( 10, 14);
            st_vnii_mps_est   = st_line.substr( 24, 14);
            st_vni_mps_truth  = st_line.substr( 52, 14);
        ...
        Ostream_pos_mag2.close();


        std::ifstream Ostream_gps_mag3;
        Ostream_gps_mag3.open(st_file_gps_complete_mag3);
        std::getline(Ostream_gps_mag3, st_first_line);
        ...
        while (std::getline(Ostream_gps_mag3, st_line)) {
            st_t_sec          = st_line.substr(  0, 10);
            st_vni_mps_est    = st_line.substr( 10, 14);
            st_vnii_mps_est   = st_line.substr( 24, 14);
            st_vni_mps_truth  = st_line.substr( 94, 14);
        ...
        Ostream_gps_mag3.close();

        std::ifstream Ostream_pos_mag3;
        Ostream_pos_mag3.open(st_file_pos_complete_mag3);
        std::getline(Ostream_pos_mag3, st_first_line);
        std::getline(Ostream_pos_mag3, st_line); // line repeated at 100 [sec] from previous file
        while (std::getline(Ostream_pos_mag3, st_line)) {
            st_t_sec          = st_line.substr(  0, 10);
            st_vni_mps_est    = st_line.substr( 10, 14);
            st_vnii_mps_est   = st_line.substr( 24, 14);
            st_vni_mps_truth  = st_line.substr( 52, 14);
    ...
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "MAG better" << setw(24) << "MAG worse" << std::endl;
    ...
    std::string st_file_out = "versus_mag_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_mag_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{6}{c}{\\textbf{MAG Configuration}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_mag::obtain_xhor_mag_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "MAIN";
    std::string st_folder_one_mag2 = "MAG_BETTER";
    std::string st_folder_one_mag3 = "MAG_WORSE";
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        st_folder.replace(3,2,st_seeds);
        st_file_complete   = (path_outputs_read / st_folder_main / st_folder_one      / st_folder / st_file).string();
        st_file_complete_2 = (path_outputs_read / st_folder_main / st_folder_one_mag2 / st_folder / st_file).string();
        st_file_complete_3 = (path_outputs_read / st_folder_main / st_folder_one_mag3 / st_folder / st_file).string();
    ...
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "MAG better" << "MAG worse" << std::endl;
    std::cout << setw(10) << " "
    ...
    std::string st_file_out = "versus_mag_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_mag_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{7}{c}{\\textbf{MAG Configuration}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_mag::obtain_euler_mag_alter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_mag2 = "ALTER_MAG_BETTER";
    std::string st_folder_one_mag3 = "ALTER_MAG_WORSE";
    ...
    std::string st_file_out = "versus_mag_alter_euler_deg.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_mag_alter_euler_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{9}{c}{\\textbf{MAG Configuration} \\nm{\\lrsb{deg}}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_mag::obtain_vn_mag_alter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_mag2 = "ALTER_MAG_BETTER";
    std::string st_folder_one_mag3 = "ALTER_MAG_WORSE";
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        Ostream_gps_2.open(st_file_gps_complete_mag2);
        ...
        Ostream_pos_2.open(st_file_pos_complete_mag2);
        ...
        Ostream_gps_3.open(st_file_gps_complete_mag3);
        ...
        Ostream_pos_3.open(st_file_pos_complete_mag3);
    ...
    std::string st_file_out = "versus_mag_alter_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_mag_alter_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{6}{c}{\\textbf{MAG Configuration}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Better}} & \\multicolumn{2}{c}{\\textbf{Worse}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\lrsb{m/sec}} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{}} "
...
void nav::test::Tplots_sensors_mag::obtain_xhor_mag_alter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_mag2 = "ALTER_MAG_BETTER";
    std::string st_folder_one_mag3 = "ALTER_MAG_WORSE";
    ...
    std::cout << std::endl;
    std::cout << "xhor position filter error [m,%]:" << std::endl;
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "MAG better" << setw(28) << "MAG worse" << std::endl;
    std::cout << setw(10) << " "
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
              << setw(11) << "distance" << setw(17) << "hor error"
    ...
    std::string st_file_out = "versus_mag_alter_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_mag_alter_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{7}{c}{\\textbf{ACC Configuration}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Better}} & \\multicolumn{2}{c}{\\textbf{Worse}} \\\\" << std::endl;
    Oout_tex << " & Distance \\nm{\\lrsb{m}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{\\Deltaxhor}} "
