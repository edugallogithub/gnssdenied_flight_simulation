...
nav::test::Tplots_att_filter_alter::Tplots_att_filter_alter(unsigned short& seed_init, unsigned short& seed_end)
: _seed_init(seed_init), _seed_end(seed_end) {
}
/* constructor based on counter */

void nav::test::Tplots_att_filter_alter::run() {
    obtain_euler_att_filter_metrics         ("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_vn_att_filter_metrics            ("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_turn_location_att_filter_metrics ("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_xhor_att_filter_metrics          ("03_01_05_03_04_0100", _seed_init, _seed_end);
}
...
void nav::test::Tplots_att_filter_alter::obtain_euler_att_filter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "ALTER_MAIN";
    std::string st_folder_one2 = "ALTER_ATT_FILTER_03";
    std::string st_folder_one3 = "ALTER_ATT_FILTER_04";
    ...
    std::string st_extra_folder("versus_att_filter_alter");
    ...
    std::string st_file_out = "versus_att_filter_alter_euler_deg.txt";
    ...
    std::string st_file_out_tex = "versus_att_filter_alter_euler_table.tex";
    ...
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{9}{c}{\\textbf{Attitude Filter Configuration}} \\\\" << std::endl;
...
void nav::test::Tplots_att_filter_alter::obtain_vn_att_filter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_gyr2 = "ALTER_ATT_FILTER_03";
    std::string st_folder_one_gyr3 = "ALTER_ATT_FILTER_04";
    ...
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "GYR better" << setw(24) << "GYR worse" << std::endl;
    ...
    std::string st_file_out = "versus_att_filter_alter_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_att_filter_alter_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{8}{c}{\\textbf{Attitude Filter Configuration}} \\\\" << std::endl;
...
void nav::test::Tplots_att_filter_alter::obtain_turn_location_att_filter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder      = st_first_folder;
    std::string st_folder_one  = "ALTER_MAIN";
    ...
    std::string st_file_out = "versus_att_filter_alter_turn_location.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
...
void nav::test::Tplots_att_filter_alter::obtain_xhor_att_filter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_gyr2 = "ALTER_ATT_FILTER_03";
    std::string st_folder_one_gyr3 = "ALTER_ATT_FILTER_04";
    ...
    std::string st_file_out = "versus_att_filter_alter_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_att_filter_alter_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
