#ifndef RESULTS_ANA_TEST_PLOTS_ATT_FILTER
#define RESULTS_ANA_TEST_PLOTS_ATT_FILTER
...
class Tplots_att_filter {
private:
    unsigned short _seed_init;
    unsigned short _seed_end;
public:
	/**< constructor based on counter */
	explicit Tplots_att_filter(unsigned short& seed_init, unsigned short& seed_end);
