...
nav::test::Tplots_sensors_gyr::Tplots_sensors_gyr(unsigned short& seed_init, unsigned short& seed_end)
: _seed_init(seed_init), _seed_end(seed_end) {
}
/* constructor based on counter */

void nav::test::Tplots_sensors_gyr::run() {
    obtain_euler_gyr_metrics ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_vn_gyr_metrics    ("01_01_05_02_03_0100", _seed_init, _seed_end);
    obtain_xhor_gyr_metrics  ("01_01_05_02_03_0100", _seed_init, _seed_end);

    obtain_euler_gyr_alter_metrics("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_vn_gyr_alter_metrics   ("03_01_05_03_04_0100", _seed_init, _seed_end);
    obtain_xhor_gyr_alter_metrics ("03_01_05_03_04_0100", _seed_init, _seed_end);
}
...
void nav::test::Tplots_sensors_gyr::obtain_euler_gyr_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "MAIN";
    std::string st_folder_one_gyr2 = "GYR_BETTER";
    std::string st_folder_one_gyr3 = "GYR_WORSE";
    std::string st_folder_one_gyr4 = "GYR_WORST";
    ...
    std::string st_extra_folder("versus_gyr");
    std::string st_file("filter_att_euler.txt");

    std::string st_seeds, st_file_complete, st_first_line, st_file_complete_gyr2, st_file_complete_gyr3, st_file_complete_gyr4;
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        st_file_complete_gyr2 = (path_outputs_read / st_folder_main / st_folder_one_gyr2 / st_folder / st_file).string();
        st_file_complete_gyr3 = (path_outputs_read / st_folder_main / st_folder_one_gyr3 / st_folder / st_file).string();
        st_file_complete_gyr4 = (path_outputs_read / st_folder_main / st_folder_one_gyr4 / st_folder / st_file).string();
        ...
        Ostream2.open(st_file_complete_gyr2);
        ...
        Ostream3.open(st_file_complete_gyr3);
        ...
        Ostream4.open(st_file_complete_gyr4);
    ...
    std::cout << setw(10) << " " << setw(21) << "baseline" << setw(21) << "GYR better" << setw(21) << "GYR worse" << setw(21) << "GYR worst" << std::endl;
    std::cout << setw(10) << " "
    ...
    std::string st_file_out = "versus_gyr_euler_deg.txt";
    ...
    std::string st_file_out_tex = "versus_gyr_euler_table.tex";
    ...
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{12}{c}{\\textbf{GYR Configuration} \\nm{\\lrsb{deg}}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_gyr::obtain_vn_gyr_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "MAIN";
    std::string st_folder_one_gyr2 = "GYR_BETTER";
    std::string st_folder_one_gyr3 = "GYR_WORSE";
    ...
    std::string st_seeds, st_file_gps_complete, st_first_line, st_line, st_file_gps_complete_gyr2, st_file_gps_complete_gyr3, st_file_gps_complete_gyr4;
    std::string st_file_pos_complete, st_file_pos_complete_gyr2, st_file_pos_complete_gyr3, st_file_pos_complete_gyr4;
    unsigned long nel     = (unsigned long)(seed_end) - (unsigned long)(seed_init) + 1;
    unsigned long nel_all = 380001;
    unsigned long nel_sec = 381;
    unsigned long index_all, index_sec;
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        st_file_gps_complete_gyr4 = (path_outputs_read / st_folder_main / st_folder_one_gyr4 / st_folder / st_file_gps).string();
        ...
        st_file_pos_complete_gyr4 = (path_outputs_read / st_folder_main / st_folder_one_gyr4 / st_folder / st_file_pos).string();
        ...
        std::ifstream Ostream_gps_gyr4;
        Ostream_gps_gyr4.open(st_file_gps_complete_gyr4);
        std::getline(Ostream_gps_gyr4, st_first_line);
        ...
        while (std::getline(Ostream_gps_gyr4, st_line)) {
            st_t_sec          = st_line.substr(  0, 10);
            st_vni_mps_est    = st_line.substr( 10, 14);
            st_vnii_mps_est   = st_line.substr( 24, 14);
            st_vni_mps_truth  = st_line.substr( 94, 14);
        ...
        Ostream_gps_gyr4.close();

        std::ifstream Ostream_pos_gyr4;
        Ostream_pos_gyr4.open(st_file_pos_complete_gyr4);
        std::getline(Ostream_pos_gyr4, st_first_line);
        std::getline(Ostream_pos_gyr4, st_line); // line repeated at 100 [sec] from previous file
        while (std::getline(Ostream_pos_gyr4, st_line)) {
            st_t_sec          = st_line.substr(  0, 10);
            st_vni_mps_est    = st_line.substr( 10, 14);
            st_vnii_mps_est   = st_line.substr( 24, 14);
            st_vni_mps_truth  = st_line.substr( 52, 14);
    ...
    std::cout << setw(10) << " " << setw(24) << "baseline" << setw(24) << "GYR better" << setw(24) << "GYR worse" << setw(24) << "GYR worst" << std::endl;
    ...
    std::string st_file_out = "versus_gyr_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_gyr_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{8}{c}{\\textbf{GYR Configuration}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_gyr::obtain_xhor_gyr_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "MAIN";
    std::string st_folder_one_gyr2 = "GYR_BETTER";
    std::string st_folder_one_gyr3 = "GYR_WORSE";
    ...
    for (unsigned short seed = seed_init; seed <= seed_end; ++seed) {
        ...
        st_file_complete_4 = (path_outputs_read / st_folder_main / st_folder_one_gyr4 / st_folder / st_file).string();
    ...
    std::cout << setw(10) << " " << setw(28) << "baseline" << setw(28) << "GYR better" << setw(28) << "GYR worse" << setw(28) << "GYR worst" << std::endl;
    std::cout << setw(10) << " "
    ...
    std::string st_file_out = "versus_gyr_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_gyr_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Benchmark} & \\multicolumn{9}{c}{\\textbf{GYR Configuration}} \\\\" << std::endl;
...
void nav::test::Tplots_sensors_gyr::obtain_euler_gyr_alter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_gyr2 = "ALTER_GYR_BETTER";
    std::string st_folder_one_gyr3 = "ALTER_GYR_WORSE";
    std::string st_folder_one_gyr4 = "ALTER_GYR_WORST";
    ...
    std::string st_file_out = "versus_gyr_alter_euler_deg.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_gyr_alter_euler_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{12}{c}{\\textbf{GYR Configuration} \\nm{\\lrsb{deg}}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\| \\phiNBest - \\phiNB \\|} & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{3}{c}{\\textbf{Better}} & \\multicolumn{3}{c}{\\textbf{Worse}} & \\multicolumn{3}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\mumu{}, \\, \\musigma{}, \\, \\mumax{\\cdot}} "
             << " & \\textbf{"
...
void nav::test::Tplots_sensors_gyr::obtain_vn_gyr_alter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_gyr2 = "ALTER_GYR_BETTER";
    std::string st_folder_one_gyr3 = "ALTER_GYR_WORSE";
    ...
    std::string st_file_out = "versus_gyr_alter_vned_mps.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_gyr_alter_vned_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{8}{c}{\\textbf{GYR Configuration}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{2}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Better}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << "\\nm{\\lrsb{m/sec}} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} & \\nm{\\vNesti - \\vNi} & \\nm{\\vNestii - \\vNii} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{}} "
...
void nav::test::Tplots_sensors_gyr::obtain_xhor_gyr_alter_metrics(const std::string& st_first_folder, unsigned short& seed_init, unsigned short& seed_end) {
    std::string st_folder          = st_first_folder;
    std::string st_folder_one      = "ALTER_MAIN";
    std::string st_folder_one_gyr2 = "ALTER_GYR_BETTER";
    std::string st_folder_one_gyr3 = "ALTER_GYR_WORSE";
    ...
    std::string st_file_out = "versus_gyr_alter_pos_hor_m_pc.txt";
    std::string st_file_output = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out).string();
    ...
    std::string st_file_out_tex = "versus_gyr_alter_pos_hor_table.tex";
    std::string st_file_output_tex = (path_outputs_write / st_folder_main / st_extra_folder / st_file_out_tex).string();
    ...
    Oout_tex << "\\begin{tabular}{lrrrrrrrrr}" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\textbf{Alternate} & \\multicolumn{9}{c}{\\textbf{GYR Configuration}} \\\\" << std::endl;
    Oout_tex << " & \\multicolumn{3}{c}{\\textbf{Baseline}} & \\multicolumn{2}{c}{\\textbf{Better}} & \\multicolumn{2}{c}{\\textbf{Worse}} & \\multicolumn{2}{c}{\\textbf{Worst}} \\\\" << std::endl;
    Oout_tex << " & Distance \\nm{\\lrsb{m}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} & \\multicolumn{2}{c}{\\nm{\\Deltaxhor \\lrsb{m,\\%}}} \\\\" << std::endl;
    Oout_tex << "\\hline" << std::endl;
    Oout_tex << "\\nm{\\muEND{\\Deltaxhor}} "
